...
if(_f-(_d._outerHeight()+12+(_c.trackMouse?12:0))<0){
_c.position='bottom';
_f+=t._outerHeight()+12+(_c.trackMouse?12:0);
_d.removeClass("tooltip-top").addClass("tooltip-bottom");
}
else{
...
box.next().bind("mouseenter.validatebox", function() {
if (box.hasClass("validatebox-invalid")) {
_3cd(_3ca);
}
}).bind("mouseleave.validatebox", function() {
...
$.fn.validatebox.defaults = { required: false, validType: null, delay: 200, missingMessage: "This field is required.", invalidMessage: null, tipPosition: "top", deltaX: 0, tipOptions: { showEvent: "mouseenter", hideEvent: "mouseleave", showDelay: 0, hideDelay: 0, zIndex: "", onShow: function() {
...
var _goon=_ac.onBeforeDrop.call(_ab,_b5,_b4,_b7);
if(_goon!=undefined && !_goon){
_return=false;
}else{
_b6(_b4,_b5,_b7);
}
...
win.window({title:_223,noheader:(_223?false:true),width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,closable:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
...
titleValue = "<div style='margin-top:20px;'>" + _309.east.panel("options").title + "</div>";
titleCls = "layout-expand";
}else{
if(dir=="west"){
icon="layout-button-right";
titleValue = "<div style='margin-top:20px;'>" + _309.west.panel("options").title + "</div>";
titleCls = "layout-expand";
}else{
if(dir=="north"){
icon="layout-button-down";
titleValue = _309.north.panel("options").title;
titleCls = "layout-expand-ex";
}else{
if(dir=="south"){
icon="layout-button-up";
titleValue = _309.south.panel("options").title;
titleCls = "layout-expand-ex";
}
}
}
}
var p=$("<div></div>").appendTo(_306).panel({cls:titleCls,title:titleValue,closed:true,doSize:false,tools:[{iconCls:icon,handler:function(){
_30f(_306,_307);
return false;
}}]});
...
if($.data(this, 'menu').options.isauto){
...
$.fn.menu.defaults={isauto:true,zIndex:110000,left:0,top:0,onShow:function(){
},onHide:function(){
...
//_3b0(_3af);
$(_3af).find(".validatebox-text:not(:disabled)").validatebox("clear");
};
function _3b1(_3b2){
